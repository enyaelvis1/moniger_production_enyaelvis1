...
const AppHeader = ({ pageTitle }: { pageTitle: string }) => {
  ...
  return (
    <header className="h-14 border-b border-[#E0DFF0] dark:border-border bg-white dark:bg-card flex items-center justify-between px-3 sm:px-4 md:px-6 shrink-0">
